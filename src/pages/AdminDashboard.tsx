      ...
      <SecureAdminWrapper>
        <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Secure Admin Dashboard</h1>
              <p className="text-muted-foreground">Manage immigration news, users, and system security</p>
            </div>
